/**
 * Client-safe participation & accuracy computation (no Node deps).
 * Mirrors lib/participation.ts for use in the browser.
 */
...
export type SessionDataForCompute = {
...
export function computeParticipationAndAccuracyClient(
  sessionData: SessionDataForCompute,
  roster: RosterEntry[]
): SessionSummary {
